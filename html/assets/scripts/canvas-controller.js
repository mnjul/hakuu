  ...
  (function () {
    ...
    RainEngineClient = class {
      constructor(contentCanvas, viewportCanvas, raining, dppx) {
        const raindrops = (_(this)._raindrops = new window.RainEngine.Raindrops(
  ...
  (function () {
    ...
    class CanvasController {
      ...
      _setCanvasSize() {
        ...
        const { width: viewportWidth, height: viewportHeight } = _(
          this
        )._viewport.getBoundingClientRect();
      ...
      _prepareViewportPageCanvas() {
        let canvasCtx = _(this)._viewportPageCanvas.getContext('2d', {
          alpha: false,
        });
        ...
        canvasCtx =
          _(this)._viewport.getContext('webgl', { alpha: false }) ??
          _(this)._viewport.getContext('experimental-webgl', { alpha: false });
      ...
      _renderViewportPageCanvas() {
        ...
        canvasCtx.fillStyle = _(this)._bgColor;
        canvasCtx.fillRect(0, 0, widthDots, canvasHeightDots);
      ...
      async _preparePageBitmap(abortSignal, dppx) {
        ...
        if (
          ...
          _(this)._pageOfCurrentWidth = (
            await _(this)._pageSourcePromise
          ).asRenderedPage(
            styleSheet,
            isSmallView(),
            Object.assign(
              ...
              !isSmallView()
                ? {
                    paddingTop:
                      $computedStyle('#sidebar', 'top', parseFloat) /
                      window.REM_SCALE,
                  }
                : {}
            ),
          ...
          const resolvedBitmap = await _(
            this
          )._pageOfCurrentWidth.imagePromise();
        ...
        $('#main').style.setProperty(
          '--ghost-container-height',
          `${_(this)._pageOfCurrentWidth.contentHeightDots / dppx}px`
        );
      }
      ...
      _attachEvents() {
        ...
        _(this)._viewport.addEventListener(
          'mousemove',
          _(this)._onMousemoveBound
        );
      ...
      _detachEvents() {
        ...
        _(this)._viewport.removeEventListener(
          'mousemove',
          _(this)._onMousemoveBound
        );
      ...
      _onMousemove(evt) {
        ...
        const pageXDots = evt.offsetX * dppx;
        const pageYDots = evt.offsetY * dppx + _(this)._currentScrollOffsetDots;
      ...
      _onScroll() {
        ...
        _(this)._currentScrollOffsetDots =
          document.documentElement.scrollTop * dppx;
        ...
        _(this)._pageOfCurrentWidth.triggerActionable(
          ...
          (actionable) => {
            switch (actionable.action) {
              ...
              case 'inner-nav': {
                const target = _(this)._pageOfCurrentWidth.getInnerNavTarget(
                  actionable.target
                );
                if (target) {
                  let margin = INNER_PAGE_SCROLL_TOP_MARGIN;
                  if (isSmallView()) {
                    margin += $computedStyle(
                      'html',
                  ...
                  _(this)._smoothScrollTop(
                    target.top / window.devicePixelRatio - margin
                  );
                }
                break;
              }
