...
func main() {
	...
	parseFile("../html/index.html", cjk_chars, cjk_puncs, latin_chars)
	...
	for _, path := range []string{"../html/pages/", "../html/assets/styles/"} {
		...
		for _, fileInfo := range fileInfos {
			parseFile(path+fileInfo.Name(), cjk_chars, cjk_puncs, latin_chars)
		}
	}
...
func parseFile(filepath string, cjk_chars map[rune]bool, cjk_puncs map[rune]bool, latin_chars map[rune]bool) {
